...
export interface BuildSeed {
  ...
  // extracted from it (kept in pasteContent) — enough to put the review box
  // back on screen pre-filled, instead of silently losing it, which reads as
  // "my document was deleted".
